...
def evaluations(response, query):
    ...
    with st.spinner("Evaluating..."):
        evals = evaluate(dataset, metrics=[answer_relevancy, context_relevancy, faithfulness])
        evals_df = [
            ...
            ["context_relevancy", f'{100*evals["context_relevancy"]:0.0f}%', 'context vs. question','Calculates the % of sentences in the context that are relevant for answering the question'], 
